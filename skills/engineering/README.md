...
- **[to-spec](./to-spec/SKILL.md)** — Turn the current conversation into a spec and publish it to the issue tracker — one vertical slice becomes a single ready-to-build issue, anything larger becomes an in-progress project with an overview and spec documents on Linear, or a single issue elsewhere.
