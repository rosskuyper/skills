...
- **[to-spec](./to-spec/SKILL.md)** — Turn the current conversation into a spec and publish it to the issue tracker — as an in-progress project with an overview and spec documents on Linear, or a single issue elsewhere.
...
- **[implement](./implement/SKILL.md)** — Build the work described by a spec, project, or ticket — resolving it into an ordered work list, taking the frontier ticket, driving `/tdd` at pre-agreed seams and closing out with `/code-review` before committing.
