...
Most of the skills come from https://github.com/mattpocock/skills - for now all credit to him
...
These skills exist to fix common failure modes in Claude Code, Codex, and other coding agents.
...
These are the skills to reach for most often. They help you align with the agent before you get started, and think deeply about the change you're making. Use them _every_ time you want to make a change.
...
Here's [an example `CONTEXT.md`](https://github.com/mattpocock/course-video-manager/blob/076a5a7a182db0fe1e62971dd7a68bcadf010f1c/CONTEXT.md) from a real project. Which of these is easier to read?
...
- **[to-spec](./skills/engineering/to-spec/SKILL.md)** — Turn the current conversation into a spec and publish it to the issue tracker. Work that is one vertical slice lands as a single issue with its own acceptance criteria, ready for `/implement`. Anything larger lands as an in-progress project whose overview links to a document per spec section on Linear, or a single issue elsewhere. No interview — just synthesizes what you've already discussed.
...
- **[implement](./skills/engineering/implement/SKILL.md)** — Build the work described by a spec, project, or ticket. Resolves whatever you point it at into an ordered work list, then orchestrates it unattended — a fresh subagent per slice driving `/tdd` at the pre-agreed seams, its work verified and `/code-review`ed and committed ticket by ticket.
